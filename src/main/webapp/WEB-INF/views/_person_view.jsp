...
<ul class="topnav">
	<li><a href="persons" class="w3-button">Contact Manager</a></li>
	<li><a href="person/new" class="w3-button">Add Contact</a></li>
	<li><a href="about" class="w3-button">About</a></li>
	<li><a href="contact-us" class="w3-button">Contact Us</a></li>
</ul>
				...
				<c:forEach items="${listPersons}" var="person">
					<tbody>
						<tr>
							...
							<td><a href="<c:url value='/view/${person.id}' />">View3
							</a></td>
						</tr>
					</tbody>
				</c:forEach>
